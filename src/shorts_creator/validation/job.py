...
from shorts_creator.validation.subtitle_normalize import normalize_subtitle_text, normalize_subtitle_tokens
...
def validate_job(
    *,
    ...
    """Validate one job and optionally update its manifest gates."""
    ...
    import io
    validator = JobValidator(metadata_path, verbose=verbose)

...
def test_preference_template_is_explicitly_unlabeled():
    assert benchmark.preferences_status() == "AWAITING_HUMAN_REVIEW"


def test_result_schema_accepts_only_frozen_statuses():

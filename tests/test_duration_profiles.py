...
def test_word_budget_generate_script_uses_budget():
    """Verify generate_script's _build_duration_prompt_instruction uses budget."""
    from generate_script import _build_duration_prompt_instruction
...
def test_word_budget_retry_instruction_contains_correction():
    ...
    from generate_script import _build_retry_instruction
    budget = calculate_word_budget(target_sec=35, min_sec=32, max_sec=38, scene_count=5)
    instruction = _build_retry_instruction(budget, actual_word_count=54, actual_scene_count=5, estimated_dur=30.9)
...
def test_system_prompt_no_fixed_duration():
    ...
    from generate_script import SYSTEM_PROMPT

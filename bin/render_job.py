...
def main() -> int:
    ...
    parser.add_argument('--skip-render', action='store_true', help='Skip FFmpeg render and post-render validation (still generates manifest)')
    ...
    if not args.skip_render:
        ...
        validation_result = {
            ...
            "preflightOk": args.skip_validation or True,
            "postRender": post,
        ...
        if is_continuous_audio:
            try:
                from audio_validation import run_audio_validation

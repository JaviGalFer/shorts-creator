...
- Branch full suite after adaptive runtime hardening: `1213 passed, 51 skipped, 0 failed`. The skips are legacy bootstrap-compression convergence tests, superseded by active post-TTS fitting coverage. Next exact step: `python3 bin/run_job.py --topic "Cómo funciona un agujero negro" --duration-preset deep_60 --verbose`.
